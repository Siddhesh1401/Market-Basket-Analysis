...
This folder contains simple handoff notes for completed phases.

Use these files when you want to quickly understand:
- what was built in a phase
- how to test that phase in a few minutes
